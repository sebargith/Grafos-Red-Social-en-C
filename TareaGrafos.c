...
int main() {
    ...
    printf("\nIngrese los criterios de busqueda\nIngrese el pais, (si no es importante ingrese -1): ");
    scanf("%s", p);
    ...
    printf("\nlos criterios seleccionados fueron: %s %d %d %s \n",p ,edadminima, edadmaxima, hobby);
    ...
    printf("ingrese numero valido entre 0 y 1\n");
